<?php
/**
Plugin Name: Ultra Demo Importer
Plugin URI:  http://ultrapress.uncodethemes.com/main/
Description: Ultra Demo Importer is a plugin to import ready to use demo sites for different themes developed by Uncode themes.
Version:     1.0.5
Author:      Uncodethemes
 ...
 * Importer constants
 */
defined( 'UTDI_VER' ) or define( 'UTDI_VER', '1.0.4' ); // defining plugin version
...
defined( 'UTDI_DEMO_URL' ) or define( 'UTDI_DEMO_URL', 'http://demo.uncodethemes.com/demo-importer/' ); // defining 
